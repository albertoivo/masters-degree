...
\begin{table}[htb]
    ...
    \begin{tabular}{p{5.5cm} *{8}{c}}
        ...
        \midrule
        \textbf{Revisão Sistemática da Literatura} & X & X & X & X & X & X & X & X \\
        \addlinespace
        \textbf{Construção do Banco de Dados Rotulado} &  & X & X & X &  &  &  &  \\
        \addlinespace
        \textbf{Pré-processamento e Data Augmentation} &  &  & X & X &  &  &  &  \\
        \addlinespace
        \textbf{Implementação de Modelos de ML} &  &  & X & X & X & X &  &  \\
        \addlinespace
        \textbf{Experimentos de XAI} &  &  &  & X & X & X &  &  \\
        \addlinespace
