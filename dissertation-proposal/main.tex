...
\usepackage{hyperref}
\hypersetup{
  pdftitle={DETECÇÃO AUTOMÁTICA DE BOLHAS DE PLASMA EQUATORIAL EM IMAGENS AIRGLOW UTILIZANDO TÉCNICAS DE APRENDIZADO PROFUNDO},
...
% Metadados/capa
\titulo{DETECÇÃO AUTOMÁTICA DE BOLHAS DE PLASMA EQUATORIAL EM IMAGENS AIRGLOW UTILIZANDO TÉCNICAS DE APRENDIZADO PROFUNDO}
